...
*   **Mega-Cap Safe Havens:** During tech-sector corrections, cash-rich mega-caps occasionally act as corporate fortress balance sheets. Because QQQ is heavily weighted in these giants, it can exhibit shallower drawdowns than QQQE.
*   **Concentration Busts:** However, when valuation bubbles pop specifically within the mega-cap cohort, QQQ suffers deeper, more punishing peak-to-trough drawdowns. QQQE's diversified structure mitigates this concentration penalty.
